        ...
        <div className="flex border border-slate-200/50 bg-slate-50 p-1 rounded-xl text-xs font-semibold select-none mb-4" id="cad-navigation-scroller">
          <button
            ...
            className={`flex-1 py-2 text-center rounded-lg flex items-center justify-center gap-1.5 transition-all text-slate-505 hover:text-slate-900 cursor-pointer ${
              activeTab === 'library' ? 'bg-white shadow-xs text-cyan-600 font-bold border border-slate-200/40' : ''
            }`}
          >
          ...
          <button
            ...
            className={`flex-1 py-2 text-center rounded-lg flex items-center justify-center gap-1.5 transition-all text-slate-505 hover:text-slate-900 cursor-pointer ${
              activeTab === 'rooms' ? 'bg-white shadow-xs text-cyan-600 font-bold border border-slate-200/40' : ''
            }`}
          >
          ...
          <button
            ...
            className={`flex-1 py-2 text-center rounded-lg flex items-center justify-center gap-1.5 transition-all text-slate-505 hover:text-slate-900 cursor-pointer ${
              activeTab === 'reports' ? 'bg-white shadow-xs text-cyan-600 font-bold border border-slate-200/40' : ''
            }`}
          >
        ...
        <div className="flex-1 overflow-y-auto pr-1 space-y-4 font-sans" id="cad-active-panel-wrapper">
          ...
          {activeTab === 'library' && (
            <div className="space-y-4 animate-in fade-in duration-200">
              ...
              <div className="p-3.5 rounded-xl border border-cyan-100 bg-gradient-to-br from-cyan-50/50 to-cyan-50/20 space-y-3 shadow-3xs" id="network-telemetry-panel">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-1.5">
                    <Wifi className="w-4 h-4 text-cyan-600 animate-pulse" />
                    <span className="text-xs font-bold text-slate-800 tracking-tight font-sans">Network Infrastructure Overlays</span>
                  </div>
                  <span className="text-[9.5px] font-mono font-bold bg-cyan-100 text-cyan-700 px-1.5 py-0.5 rounded-md">MDU v1.5</span>
                </div>
                ...
                <div className="bg-white/80 border border-slate-200/60 rounded-lg p-2 flex flex-col gap-1.5">
                  <div className="flex justify-between items-center text-[10px] text-slate-500 font-medium">
                    <span className="font-mono flex items-center gap-1"><Cpu className="w-3 h-3 text-cyan-500" /> Optimal AP Planner</span>
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      toast.className = "fixed bottom-14 right-5 bg-cyan-600 text-white text-xs font-semibold px-4 py-3 rounded-xl shadow-2xl border border-cyan-400 z-50 flex items-center gap-2 animate-in slide-in-from-bottom-4 duration-300";
                      if (placedCount > 0) {
              ...
              <div className="flex justify-between items-center bg-slate-50 px-3 py-2 rounded-xl border border-slate-200/60">
                ...
                <select
                  ...
                  className="bg-white border border-slate-220 rounded-lg px-2 py-0.5 text-xs text-slate-700 font-medium focus:outline-none focus:border-cyan-500 cursor-pointer"
                >
                        ...
                        >
                          <div className="flex items-center gap-2.5">
                            ...
                            <div className="max-w-[180px] md:max-w-xs font-sans">
                              <span className="text-xs font-bold text-slate-800 group-hover:text-cyan-700 block">{item.label}</span>
                          ...
                          <div className="flex items-center gap-1.5 shrink-0">
                            ...
                            <div className="p-1.5 rounded-lg bg-cyan-50 text-cyan-600 group-hover:bg-cyan-600 group-hover:text-white transition-all shadow-xs">
            ...
            <div className="space-y-4 animate-in fade-in duration-200">
              ...
              <div className="p-4 rounded-xl border border-cyan-100 bg-cyan-50/30 space-y-3">
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <label className="flex items-center justify-center gap-1.5 py-2 rounded-lg bg-white border border-slate-200 hover:border-cyan-300 hover:bg-cyan-50 text-slate-600 hover:text-cyan-700 text-xs font-bold transition-all shadow-xs cursor-pointer">
                ...
                <div className="space-y-2 pt-1">
                  <div className="relative">
                    <input 
                      ...
                      className="w-full text-xs py-2 pl-8 pr-3 rounded-lg border border-slate-200 focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 transition-all font-sans"                
                    />
              ...
              <div className="p-4 rounded-xl border border-slate-200 bg-white shadow-xs space-y-4">
                <h3 className="text-xs font-bold text-slate-800 uppercase tracking-wider flex items-center justify-between border-b border-slate-100 pb-2 mb-1 font-mono">
                  <span className="flex items-center gap-1.5">
                    <FileImage className="w-3.5 h-3.5 text-cyan-600" />
                    Blueprint Uploader
                  </span>
                  {blueprintImage && (
                ...
                <div className="relative">
                  <label 
                    className={`flex flex-col items-center justify-center border-2 border-dashed rounded-xl p-4 text-center cursor-pointer transition-all ${
                      blueprintImage 
                        ? 'border-cyan-300 bg-cyan-50/20 hover:bg-cyan-50/40' 
                  ...
                  >
                    <input 
                      ...
                      className="hidden" 
                    />
                    <Upload className={`w-6 h-6 mb-2 ${blueprintImage ? 'text-cyan-500 animate-bounce' : 'text-slate-400'}`} />
                  ...
                  {isProcessingFile && (
                    <div className="absolute inset-0 bg-white/85 flex flex-col items-center justify-center rounded-xl space-y-2">
                      ...
                      <span className="text-[10px] text-cyan-700 font-bold font-mono">Rendering PDF layout to canvas...</span>
                    </div>
                  )}
                </div>
                  ...
                  <div className="space-y-3 pt-2 bg-slate-50/30 p-3 rounded-lg border border-slate-100">
                    ...
                    <div className="space-y-1">
                      <div className="flex items-center justify-between text-[10.5px]">
                        ...
                        <span className="text-cyan-700 font-mono font-bold">{blueprintScale}m</span>
                      </div>
                      <input 
                        type="range"
                        min="10"
                    ...
                    <div className="space-y-1">
                      <div className="flex items-center justify-between text-[10.5px]">
                        ...
                        <span className="text-cyan-700 font-mono font-bold">{Math.round(blueprintOpacity * 100)}%</span>
                      </div>
                      <input 
                        type="range"
                        min="0"
                    ...
                    <div className="border-t border-slate-200/50 pt-2.5 mt-1">
                      <button
                        ...
                        className="w-full bg-gradient-to-r from-cyan-600 to-cyan-600 hover:from-cyan-700 hover:to-cyan-700 text-white font-bold py-2 px-3 rounded-lg text-xs flex items-center justify-center gap-1.5 shadow-sm hover:shadow-md transition-all cursor-pointer border border-cyan-500/30 disabled:opacity-80"
                      >
                        {isDigitizing ? (
                          <>
              ...
              <form onSubmit={triggerAddRoom} className="p-4 rounded-xl border border-slate-200 bg-slate-50/40 space-y-3">
                <h3 className="text-xs font-bold text-slate-800 uppercase tracking-wider flex items-center gap-1.5 border-b border-slate-200 pb-2 mb-1 font-mono">
                  <Plus className="w-3.5 h-3.5 text-cyan-600" /> Instantiate Custom Modular Space
                </h3>
                ...
                <div className="grid grid-cols-2 gap-2.5">
                  <div className="space-y-1 col-span-2">
                    ...
                    <input
                      ...
                      className="w-full bg-white border border-slate-200 rounded-lg px-2.5 py-1.5 text-xs text-slate-800 focus:outline-none focus:border-cyan-500 placeholder-slate-400 font-sans"
                    />
                  </div>
                    ...
                    <div className="flex gap-1.5 mt-1.5">
                      {['#f0fdf4', '#f0f9ff', '#fffbeb', '#faf5ff', '#fef2f2', '#f5f5f4'].map((color) => (
                        <button
                          ...
                          className={`w-4 h-4 rounded-full border border-slate-300 cursor-pointer ${newRoomColor === color ? 'ring-2 ring-cyan-500 scale-110 shadow-sm' : 'opacity-80'}`}
                  ...
                  <div className="space-y-1">
                    ...
                    <input
                      ...
                      className="w-full bg-white border border-slate-200 rounded-lg px-2.5 py-1.5 text-xs text-slate-800 focus:outline-none focus:border-cyan-500 font-mono"
                    />
                  </div>
                ...
                <button
                  type="submit"
                  className="w-full bg-cyan-600 hover:bg-cyan-700 text-xs text-white py-2 rounded-lg font-bold shadow-xs transition-all mt-2 cursor-pointer flex items-center justify-center gap-1.5"
                >
                  <Plus className="w-3.5 h-3.5" />
              ...
              <div className="p-3.5 bg-gradient-to-br from-cyan-50/40 via-slate-50 to-slate-100 rounded-xl border border-slate-200/80 space-y-3 shadow-3xs mt-2 text-sans" id="parametric-templates-panel">
                ...
                <div className="space-y-2 font-sans">
                  <div className="space-y-0.5">
                    ...
                    <select
                      ...
                      className="w-full bg-white border border-slate-200 rounded-lg px-2.5 py-1.5 text-xs text-slate-850 focus:outline-none focus:border-cyan-500 font-sans cursor-pointer font-semibold font-sans"
                    >
                      {rooms.map(r => (
                  ...
                  <button
                    ...
                    className="w-full bg-cyan-600 hover:bg-cyan-700 text-white text-[10.5px] font-bold py-1.5 rounded-lg shadow-sm font-sans transition-all flex items-center justify-center gap-1 cursor-pointer mt-1 font-sans"
                  >
            ...
            <div className="space-y-4 animate-in fade-in duration-200 font-sans">
              ...
              <div className="space-y-2">
                <div className="relative font-mono">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50 border border-slate-200 rounded-lg px-9 py-2.5 text-xs text-slate-700 placeholder-slate-405 focus:outline-none focus:border-cyan-500 font-mono"
                  />
                </div>
              ...
              <div className="grid grid-cols-2 gap-2 bg-slate-55 p-3 rounded-xl border border-slate-200" id="cad-blueprint-analytics-stats">
                ...
                <div className="space-y-0.5 border-l border-slate-200 pl-3">
                  ...
                  <p className="text-lg font-bold font-mono text-cyan-600 flex items-baseline gap-1">
                ...
                <div className="flex justify-between items-center text-xs">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="text-[10px] font-bold text-cyan-600 hover:text-cyan-755 flex items-center gap-1 cursor-pointer font-sans"
                    >
          ...
          <div className="space-y-3 animate-in slide-in-from-bottom duration-150 font-sans" id="active-asset-inspector-panel">
            <div className="flex items-center justify-between border-b border-slate-100 pb-2">
              <div className="flex items-center gap-1.5 font-bold text-slate-800 text-xs uppercase font-mono">
                <Settings2 className="w-4 h-4 text-cyan-600 animate-spin" style={{ animationDuration: '8s' }} />
            ...
            <div className="grid grid-cols-2 gap-2 text-xs">
              <div className="space-y-1 col-span-2">
                ...
                <input
                  ...
                  className="w-full bg-slate-50 border border-slate-200 rounded-lg px-2.5 py-1.5 text-slate-800 focus:outline-none focus:border-cyan-500 font-sans font-medium hover:border-slate-300 transition-all font-sans"
                />
              </div>
              ...
              <div className="space-y-1 col-span-2">
                ...
                <select
                  ...
                  className="w-full bg-slate-50 border border-slate-200 rounded-lg px-2 py-1.5 text-slate-700 focus:outline-none focus:border-cyan-500 font-sans text-xs font-semibold cursor-pointer"
                >
              ...
              <div className="space-y-1 col-span-2 flex flex-col gap-0.5">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-[10px] text-cyan-600 font-mono font-bold">{(selectedAsset.rotationY * (180 / Math.PI)).toFixed(0)}°</span>
                </div>
                <div className="flex items-center gap-2">
                  <input
                    type="range"
                ...
                return (
                  <div key={key} className="space-y-0.5 font-sans text-[11px]">
                    ...
                    <input
                      ...
                      className="w-full bg-slate-55 border border-slate-200 rounded-lg px-2 py-1 text-xs text-slate-850 focus:outline-none focus:border-cyan-500 font-mono"
                    />
                  </div>
                );
              })}
              ...
              <div className="mt-3 bg-slate-50 border border-slate-200/80 rounded-xl p-2.5 space-y-2.5">
                <div className="flex items-center justify-between">
                  <span className="text-[10px] font-bold text-slate-500 uppercase tracking-wider font-mono flex items-center gap-1">
                    <Hammer className="w-3.5 h-3.5 text-cyan-600" /> Parametric BIM Actions
                  </span>
                </div>
                ...
                <div className="flex gap-1.5 justify-between">
                  <button
                    ...
                    onClick={() => {
                      ...
                      const toast = document.createElement('div');
                      toast.className = "fixed bottom-14 right-5 bg-cyan-600 text-white text-xs font-semibold px-4 py-3 rounded-xl shadow-2xl z-50 flex items-center gap-1.5 animate-in slide-in-from-bottom-4 duration-300";
                      toast.innerHTML = `<span>Populated parametric spec values matching Steelcase/Aruba standard benchmarks!</span>`;
                      document.body.appendChild(toast);
                      setTimeout(() => toast.remove(), 3500);
                    }}
                    className="w-full bg-cyan-600 hover:bg-cyan-700 text-white text-[10.5px] font-bold py-1 px-2.5 rounded-lg transition-all text-center cursor-pointer shadow-3xs"
                  >
                ...
                <div className="flex gap-1 items-center border-t border-slate-200/60 pt-2">
                  <input
                    ...
                    className="flex-1 bg-white border border-slate-200 rounded-md px-2 py-1 text-[10.5px] text-slate-800 placeholder-slate-400 focus:outline-none focus:border-cyan-500 font-mono"
                  />
                  <button
                    type="button"
                    onClick={() => {
